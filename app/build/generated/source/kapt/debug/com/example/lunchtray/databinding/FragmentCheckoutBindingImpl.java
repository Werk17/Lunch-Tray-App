...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.entree_price, 11);
        sViewsWithIds.put(R.id.accompaniment_selection, 12);
    ...
    protected void executeBindings() {
        ...
        java.lang.String taxAndroidStringSubtotalViewModelTax = null;
        java.lang.String viewModelEntreeNameToString = null;
        java.lang.String totalAndroidStringSubtotalViewModelTotal = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x188L) != 0) {
                    ...
                    // read @android:string/subtotal
                    totalAndroidStringSubtotalViewModelTotal = total.getResources().getString(R.string.subtotal, viewModelTotalGetValue);
            }
            ...
            if ((dirtyFlags & 0x1a0L) != 0) {
                    ...
                    // read @android:string/subtotal
                    taxAndroidStringSubtotalViewModelTax = tax.getResources().getString(R.string.subtotal, viewModelTaxGetValue);
            }
        }
        // batch finished
        if ((dirtyFlags & 0x181L) != 0) {
        ...
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tax, taxAndroidStringSubtotalViewModelTax);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.total, totalAndroidStringSubtotalViewModelTotal);
        }
    }
